...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <div className="hidden md:flex w-17 bg-[#111010] flex-col items-center py-5 shrink-0">
        <div
          className="text-[#f97316] font-serif italic text-[11px] tracking-[3px] mb-4"
        ...
        {/* spacer balances nav to true center */}
        <div className="flex-1" />
